        	...
        	<div class="row">
        			...
        			<div class="col-sm-4">
        					<div class="card">
        							...
        							<div class="card-block">
        								<div class="container">
        									<h4 class="card-title" style="margin-top:1vh;"><?php echo $bahasa; ?></h4>
        									<br>
        									<h5 class="display-6 font-weight-normal"><?php echo "$judul"; ?></h5>
        									<br>
        									<p class="text-left text-muted"><?php echo "$penulis"; ?></p>
        								</div>
        							</div>
        					</div>
        			</div>
